...
- Codex, Claude, and Antigravity are the initial runtime allowlist, not a permanent ceiling; add any future provider only through an explicit adapter plus authority, credential-boundary, privacy-contract, and regression-test review.
