...
const EN = Object.freeze({
  ...
  'settings.troubleshooting': 'Troubleshooting', 'settings.errorLogs': 'Error logs', 'settings.errorLogsDesc': 'Only provider error incidents are kept for up to 3 days.', 'settings.openErrorLogs': 'Open error log folder', 'settings.errorLogsOpenFailed': 'Could not open the error log folder.',
...
const KO = Object.freeze({
  ...
  'settings.troubleshooting': '문제 해결', 'settings.errorLogs': '오류 로그', 'settings.errorLogsDesc': 'Provider 오류 기록만 최대 3일 동안 보관합니다.', 'settings.openErrorLogs': '오류 로그 폴더 열기', 'settings.errorLogsOpenFailed': '오류 로그 폴더를 열 수 없습니다.',
