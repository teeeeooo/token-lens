...
const EN = Object.freeze({
  ...
  'settings.openOn': 'Open on', 'settings.click': 'Click', 'settings.hover': 'Hover', 'settings.bubbleDisplay': 'Bubble display',
  ...
  'common.unavailable': 'Unavailable', 'common.noQuotaWindows': 'No quota windows', 'common.loading': 'Loading…', 'common.noUsage': 'No usage',
...
const KO = Object.freeze({
  ...
  'settings.openOn': '열기 방식', 'settings.click': '클릭', 'settings.hover': '마우스 오버', 'settings.bubbleDisplay': '버블 표시',
  ...
  'common.unavailable': '사용 불가', 'common.noQuotaWindows': '표시할 한도 구간 없음', 'common.loading': '불러오는 중…', 'common.noUsage': '사용량 없음',
...
const JA = Object.freeze({
  ...
  'settings.floatingTray':'フローティングとトレイ','settings.trayIcon':'トレイアイコン','settings.trayDesc':'システムトレイからToken Lensを利用できるようにします。','settings.bubble':'フローティングバブル','settings.bubbleDesc':'最小化ボタンでToken Lensをドラッグ可能なクォータモニターに縮小します。','settings.openOn':'開く操作','settings.click':'クリック','settings.hover':'ホバー','settings.bubbleDisplay':'バブル表示','settings.bubble.providerLimits':'Provider制限','settings.bubble.icon':'アイコンのみ','settings.bubble.lowestSession':'最小セッション制限','settings.bubble.lowestWeekly':'最小週間制限','settings.bubble.firstTwoBars':'先頭2 Providerのバー','settings.bubble.lowestRemaining':'最小残量','settings.appearance':'外観','settings.language':'インターフェース言語','settings.language.auto':'自動（システム設定）','settings.language.en':'English','settings.language.ko':'한국어','settings.language.ja':'日本語','settings.language.zh-CN':'简体中文','settings.language.zh-TW':'繁體中文','settings.theme':'テーマ','settings.theme.default':'デフォルト','settings.zoom':'ズーム','settings.compactTotal':'合計を短縮表示','settings.compactTotalDesc':'合計トークン数の横にK/M/B形式の概算値を表示します。','settings.backdrop':'Windows背景効果','settings.off':'オフ','settings.acrylic':'Acrylic','settings.refresh':'更新','settings.settings':'設定',
  ...
  'common.unavailable':'利用不可','common.noQuotaWindows':'表示できるクォータ期間なし','common.loading':'読み込み中…','common.noUsage':'使用量なし','common.refreshing':'更新中…','common.failedRefresh':'使用量を更新できませんでした','common.failedSettings':'設定を読み込めませんでした',
...
const ZH_CN = Object.freeze({
  ...
  'settings.floatingTray':'浮动与托盘','settings.trayIcon':'托盘图标','settings.trayDesc':'让 Token Lens 可从系统托盘访问。','settings.bubble':'浮动气泡','settings.bubbleDesc':'使用最小化按钮将 Token Lens 收起为可拖动的额度监视器。','settings.openOn':'打开方式','settings.click':'点击','settings.hover':'悬停','settings.bubbleDisplay':'气泡显示','settings.bubble.providerLimits':'Provider 额度','settings.bubble.icon':'仅图标','settings.bubble.lowestSession':'最低会话额度','settings.bubble.lowestWeekly':'最低周额度','settings.bubble.firstTwoBars':'前两个 Provider 条','settings.bubble.lowestRemaining':'最低剩余额度','settings.appearance':'外观','settings.language':'界面语言','settings.language.auto':'自动（跟随系统）','settings.language.en':'English','settings.language.ko':'한국어','settings.language.ja':'日本語','settings.language.zh-CN':'简体中文','settings.language.zh-TW':'繁體中文','settings.theme':'主题','settings.theme.default':'默认','settings.zoom':'缩放','settings.compactTotal':'简略总计','settings.compactTotalDesc':'在完整 Token 数旁显示 K/M/B 格式的近似值。','settings.backdrop':'Windows 背景效果','settings.off':'关闭','settings.acrylic':'Acrylic','settings.refresh':'刷新','settings.settings':'设置',
  ...
  'common.unavailable':'不可用','common.noQuotaWindows':'暂无可显示额度周期','common.loading':'加载中…','common.noUsage':'暂无使用量','common.refreshing':'刷新中…','common.failedRefresh':'无法刷新使用量','common.failedSettings':'无法加载设置',
...
const ZH_TW = Object.freeze({
  ...
  'settings.floatingTray':'浮動與系統匣','settings.trayIcon':'系統匣圖示','settings.trayDesc':'讓 Token Lens 可從系統匣存取。','settings.bubble':'浮動氣泡','settings.bubbleDesc':'使用最小化按鈕將 Token Lens 收合為可拖曳的額度監視器。','settings.openOn':'開啟方式','settings.click':'點擊','settings.hover':'懸停','settings.bubbleDisplay':'氣泡顯示','settings.bubble.providerLimits':'Provider 額度','settings.bubble.icon':'僅圖示','settings.bubble.lowestSession':'最低工作階段額度','settings.bubble.lowestWeekly':'最低每週額度','settings.bubble.firstTwoBars':'前兩個 Provider 長條','settings.bubble.lowestRemaining':'最低剩餘額度','settings.appearance':'外觀','settings.language':'介面語言','settings.language.auto':'自動（跟隨系統）','settings.language.en':'English','settings.language.ko':'한국어','settings.language.ja':'日本語','settings.language.zh-CN':'简体中文','settings.language.zh-TW':'繁體中文','settings.theme':'主題','settings.theme.default':'預設','settings.zoom':'縮放','settings.compactTotal':'簡略總計','settings.compactTotalDesc':'在完整 Token 數旁顯示 K/M/B 格式的近似值。','settings.backdrop':'Windows 背景效果','settings.off':'關閉','settings.acrylic':'Acrylic','settings.refresh':'重新整理','settings.settings':'設定',
  ...
  'common.unavailable':'無法使用','common.noQuotaWindows':'沒有可顯示額度週期','common.loading':'載入中…','common.noUsage':'沒有使用量','common.refreshing':'重新整理中…','common.failedRefresh':'無法重新整理使用量','common.failedSettings':'無法載入設定',
