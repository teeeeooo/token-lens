...
import { peHasCertificateTable } from '../scripts/verify-unsigned-pe.mjs';

function peFixture({ signed = false, pe32Plus = true } = {}) {
...
test('PE certificate table detection rejects non-PE input', () => {
